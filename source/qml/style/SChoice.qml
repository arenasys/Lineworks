...
Item {
    ...
    signal edited(string newValue, string oldValue)
    ...
    ComboBox {
        ...
        delegate: Rectangle {
            ...
            height: 20
            color: delegateMouse.containsMouse ? COMMON.bg3_5 : (index == currentIndex || (index == 0 && control.currentIndex == -1) ? COMMON.bg3 : COMMON.bg2_5)
            SText {
                id: decoText
        ...
        indicator: Rectangle {
            ...
            Canvas {
                ...
                onPaint: {
                    ...
                    var ox = width/2
                    var oy = height/2
                    var dx = root.mini ? 2.5 : 2.5
                    var dy = control.popup.visible ? -3 : 3
        ...
        contentItem: Item {
            ...
            SText {
                id: valueText
                visible: !valueEditText.activeFocus
                anchors.right: parent.right
            ...
            Rectangle {
                ...
                width: Math.min(valueEditText.contentWidth+7, valueEditText.width+5)
                visible: valueEditText.activeFocus
            ...
            STextInput {
                ...
                onEditingFinished: {
                    root.edited(valueEditText.text, valueText.text)
        ...
        popup: Popup {
            ...
            contentItem: ListView {
                ...
                ScrollBar.vertical: SScrollBarV {
                    ...
                    padding: 0
                    barWidth: 2
                    stepSize: 1/Math.ceil(parent.implicitHeight/20)
